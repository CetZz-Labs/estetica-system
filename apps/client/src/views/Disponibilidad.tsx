            ...
            <section className="bg-card border border-border rounded-lg shadow-sm p-6 sm:p-8 mb-6">
                ...
                <div className="flex flex-wrap items-end gap-3 mb-6">
                    ...
                    <button
                        ...
                        className="bg-primary hover:bg-black disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-5 py-2.5 rounded-full text-sm font-medium transition-colors cursor-pointer shadow-sm"
                    >
                        Agregar
                    </button>
                </div>
                            ...
                            .map((blocked) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="p-1.5 text-gray-400 hover:text-destructive transition-colors cursor-pointer rounded-lg hover:bg-red-50"
                                    >
