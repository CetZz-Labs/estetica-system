        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
                <div className="text-center space-y-3">
                    <FiAlertCircle size={40} className="mx-auto text-destructive" />
        ...
        <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-6">
            <div className="bg-card border border-border rounded-lg p-8 max-w-sm w-full shadow-sm space-y-6">
                ...
                <div className="space-y-2 text-center">
                    ...
                    <p className="text-gray-500 text-sm">en <span className="font-medium text-foreground">{info.tenantName}</span></p>
                </div>
