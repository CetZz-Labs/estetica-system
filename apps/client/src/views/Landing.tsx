...
function HeroIllustration() {
    return (
        <svg viewBox="0 0 520 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto max-w-lg mx-auto">
            {/* Device frame */}
            <rect x="60" y="20" width="400" height="380" rx="20" fill="white" stroke="#ebe0da" strokeWidth="1.5" />
            <rect x="68" y="28" width="384" height="364" rx="14" fill="#fff9f6" />

            {/* ── Top bar ── */}
            {/* Traffic light dots */}
            <circle cx="88" cy="48" r="4.5" fill="#e5484d" />
            <circle cx="106" cy="48" r="4.5" fill="#E5A059" />
            <circle cx="124" cy="48" r="4.5" fill="#6b8e7b" />

            {/* Logo block */}
            <rect x="148" y="38" width="24" height="20" rx="5" fill="#c18695" />
            <text x="160" y="52" textAnchor="middle" fontSize="11" fontWeight="700" fontFamily="Fraunces, serif" fill="white">S</text>

            {/* Title */}
            <text x="286" y="52" textAnchor="middle" fontSize="13" fontWeight="700" fontFamily="Fraunces, serif" fill="#5c4b43">Shear</text>

            {/* Avatar */}
            <circle cx="420" cy="48" r="10" fill="#fff9f6" stroke="#ebe0da" strokeWidth="1" />
            <circle cx="420" cy="44" r="4" fill="#D1CEC7" />
            <ellipse cx="420" cy="56" rx="6" ry="4" fill="#D1CEC7" />

            {/* ── Row 1: Stats cards ── */}
            {/* Card: Clientes */}
            <rect x="80" y="82" width="174" height="82" rx="14" fill="white" stroke="#ebe0da" strokeWidth="1" />
            <text x="94" y="112" fontSize="10" fontWeight="600" fill="#9CA3AF" fontFamily="Manrope, sans-serif" letterSpacing="1.5">CLIENTES</text>
            <text x="94" y="148" fontSize="28" fontWeight="700" fill="#5c4b43" fontFamily="Fraunces, serif">128</text>

            {/* Card: Servicios */}
            <rect x="266" y="82" width="174" height="82" rx="14" fill="white" stroke="#ebe0da" strokeWidth="1" />
            <text x="280" y="112" fontSize="10" fontWeight="600" fill="#9CA3AF" fontFamily="Manrope, sans-serif" letterSpacing="1.5">SERVICIOS</text>
            <text x="280" y="148" fontSize="28" fontWeight="700" fill="#5c4b43" fontFamily="Fraunces, serif">47</text>

            {/* ── Row 2: Timeline card ── */}
            <rect x="80" y="180" width="360" height="96" rx="14" fill="white" stroke="#ebe0da" strokeWidth="1" />
            <text x="96" y="206" fontSize="12" fontWeight="700" fill="#5c4b43" fontFamily="Fraunces, serif">Próximos retoques</text>

            {/* Timeline item 1 */}
            <circle cx="104" cy="228" r="5" fill="#6b8e7b" stroke="white" strokeWidth="2" />
            <text x="120" y="233" fontSize="11" fill="#5c4b43" fontFamily="Manrope, sans-serif">María García — Corte</text>
            <rect x="356" y="222" width="64" height="18" rx="9" fill="#6b8e7b" fillOpacity="0.1" />
            <text x="388" y="234" fontSize="10" fontWeight="600" fill="#6b8e7b" textAnchor="middle" fontFamily="Manrope, sans-serif">En 7 días</text>

            {/* Timeline item 2 */}
            <circle cx="104" cy="254" r="5" fill="#E5A059" stroke="white" strokeWidth="2" />
            <text x="120" y="259" fontSize="11" fill="#5c4b43" fontFamily="Manrope, sans-serif">Carlos Ruiz — Coloración</text>
            <rect x="356" y="248" width="64" height="18" rx="9" fill="#E5A059" fillOpacity="0.1" />
            <text x="388" y="260" fontSize="10" fontWeight="600" fill="#E5A059" textAnchor="middle" fontFamily="Manrope, sans-serif">Mañana</text>

            {/* Timeline left vertical line */}
            <line x1="108" y1="216" x2="108" y2="266" stroke="#ebe0da" strokeWidth="1.5" strokeDasharray="3 3" />

            {/* ── Row 3: Bottom cards ── */}
            {/* Card: Agenda */}
            <rect x="80" y="294" width="172" height="74" rx="14" fill="white" stroke="#ebe0da" strokeWidth="1" />
            <text x="96" y="316" fontSize="12" fontWeight="700" fill="#5c4b43" fontFamily="Fraunces, serif">Agenda</text>
            <rect x="92" y="328" width="148" height="14" rx="4" fill="#fff9f6" stroke="#ebe0da" strokeWidth="0.5" />
            <text x="98" y="339" fontSize="8" fill="#6B7280" fontFamily="Manrope, sans-serif">Lun  Mar  Mié  Jue  Vie  Sáb</text>
            <rect x="92" y="346" width="148" height="14" rx="4" fill="#6b8e7b" fillOpacity="0.12" stroke="#6b8e7b" strokeWidth="0.3" />
            <text x="98" y="357" fontSize="9" fontWeight="600" fill="#6b8e7b" fontFamily="Manrope, sans-serif">● 3 turnos programados hoy</text>

            {/* Card: Movimientos */}
            <rect x="268" y="294" width="172" height="74" rx="14" fill="white" stroke="#ebe0da" strokeWidth="1" />
            <text x="284" y="316" fontSize="12" fontWeight="700" fill="#5c4b43" fontFamily="Fraunces, serif">Movimientos</text>
            <line x1="284" y1="326" x2="420" y2="326" stroke="#ebe0da" strokeWidth="1" />
            {/* Activity 1 */}
            <circle cx="292" cy="340" r="3" fill="#E5A059" />
            <text x="302" y="344" fontSize="9" fill="#6B7280" fontFamily="Manrope, sans-serif">Corte — Sra. García</text>
            {/* Activity 2 */}
            <circle cx="292" cy="356" r="3" fill="#6b8e7b" />
            <text x="302" y="360" fontSize="9" fill="#6B7280" fontFamily="Manrope, sans-serif">Manicure — Sra. López</text>

            {/* ── Decorative elements outside device ── */}
            <motion.circle cx="24" cy="100" r="14" fill="#6b8e7b" fillOpacity="0.08"
            ...
            />
            <motion.circle cx="488" cy="60" r="10" fill="#e5484d" fillOpacity="0.06"
...
function FeatureIcon({ icon: Icon, color }: { icon: React.ElementType; color: string }) {
    return (
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" className="shrink-0">
            <rect x="2" y="2" width="52" height="52" rx="14" fill="#fff9f6" stroke="#ebe0da" strokeWidth="1.5" />
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16 sm:h-20">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            {navLinks.map(link => (
                                <a key={link.href} href={link.href}
                                    className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors no-underline"
                                >
                                    {link.label}
                                </a>
                            ))}
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            <Link to="/login"
                                className="px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-foreground transition-colors rounded-full no-underline"
                            >
                                Iniciar sesión
                            </Link>
                            <Link to="/registro"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <motion.div variants={stagger} className="text-center lg:text-left">
                            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 bg-white border border-border rounded-full px-4 py-1.5 text-xs font-semibold text-gray-500 uppercase tracking-widest mb-6 shadow-sm">
                                <FiStar size={14} className="text-ring" />
                                CRM para centros de estética
                            </motion.div>
                            <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-serif text-foreground leading-tight">
                                El sistema que{' '}
                        ...
                        >
                            <HeroIllustration />
                            {/* Floating badges */}
                            <div className="hidden sm:block absolute -left-4 bottom-12 bg-white border border-border rounded-lg px-4 py-2.5 shadow-sm">
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 rounded-full bg-background border border-border flex items-center justify-center">
                                        <FiTrendingUp size={16} className="text-ring" />
                                    </div>
                                    <div>
                            ...
                            <div className="hidden sm:block absolute -right-2 top-16 bg-white border border-border rounded-lg px-4 py-2.5 shadow-sm">
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 rounded-full bg-background border border-border flex items-center justify-center">
            ...
            <motion.section
                ...
                variants={stagger}
                className="relative py-16 sm:py-24 bg-card border-t border-border overflow-hidden scroll-mt-20"
            >
                {/* Decorative background circles */}
                <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-primary/[0.015] pointer-events-none" />
                <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-ring/[0.015] pointer-events-none" />
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
                        ...
                        <h3 className="text-3xl sm:text-4xl font-serif text-foreground">Todo lo que necesitas para gestionar tu centro</h3>
                    ...
                    <motion.div variants={stagger} className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {features.map((feat, i) => (
                            <motion.div
                                ...
                                className={`relative bg-white border border-border rounded-lg p-6 sm:p-8 group ${feat.bentoClass}`}
                            >
                                {/* Featured accent bar */}
                                {feat.featured && (
                                ...
                                <svg className="absolute top-3 right-3 w-4 h-4 text-border" viewBox="0 0 16 16" fill="currentColor">
                                    <circle cx="12" cy="4" r="1.5" />
                                </svg>
                                <svg className="absolute bottom-3 left-3 w-4 h-4 text-border rotate-180" viewBox="0 0 16 16" fill="currentColor">
                                    <circle cx="12" cy="4" r="1.5" />
                                </svg>
                                ...
                                <div className={`flex ${feat.featured ? 'flex-col lg:flex-row items-start gap-6 h-full' : 'flex-col sm:flex-row items-start gap-5'}`}>
                                    <div className={`${feat.featured ? 'w-14 h-14 shrink-0' : 'shrink-0'}`}>
                                        <FeatureIcon icon={feat.icon} color="#5c4b43" />
                                    </div>
                                    <div className={`flex flex-col ${feat.featured ? 'justify-between h-full' : ''}`}>
                                        <div>
                                            <h4 className="text-lg sm:text-xl font-serif text-foreground mb-2">{feat.title}</h4>
                                        ...
                                        {feat.featured && feat.stat && (
                                            <div className="flex items-center gap-2 mt-4 pt-4 border-t border-border">
                                                ...
                                                <span className="text-xs font-medium text-ring">{feat.stat}</span>
                                            </div>
                                        )}
                                        {feat.bentoClass === 'lg:col-span-3' && (
                        ...
                        <motion.div
                            variants={fadeUp}
                            className="relative bg-background/60 border border-border/60 rounded-lg p-6 sm:p-8 hidden lg:flex flex-row items-center justify-center gap-4 text-center overflow-hidden lg:col-span-3"
                        >
                            ...
                            <FiStar size={14} className="text-gray-300 shrink-0" />
                            <div className="w-12 h-px bg-border/60" />
                            <div className="absolute -bottom-8 -right-8 w-32 h-32 rounded-full bg-primary/[0.02] pointer-events-none" />
                            <div className="absolute -top-8 -left-8 w-24 h-24 rounded-full bg-ring/[0.02] pointer-events-none" />
                        </motion.div>
                    </motion.div>
                </div>
            </motion.section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            >
                                <div className="w-12 h-12 bg-background border border-border rounded-lg flex items-center justify-center mx-auto mb-4">
            ...
            <motion.section
                ...
                viewport={{ once: true, margin: '-80px' }}
                variants={stagger}
                className="py-16 sm:py-24 bg-card border-t border-border scroll-mt-20"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
                        <h2 className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-3">Cómo funciona</h2>
                        <h3 className="text-3xl sm:text-4xl font-serif text-foreground">Empieza en minutos</h3>
                        ...
                        {steps.map((step, i) => (
                            <motion.div key={i} variants={fadeUp} className="relative text-center">
                                ...
                                <motion.div
                                    ...
                                    className="w-16 h-16 rounded-full bg-primary text-white flex items-center justify-center mx-auto mb-6 shadow-sm"
                                >
            ...
            >
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div
                        variants={fadeUp}
                        className="bg-card border border-border rounded-3xl p-8 sm:p-12 lg:p-16 shadow-sm relative overflow-hidden"
                    >
                        {/* Abstract decoration */}
                        <div className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-ring/5" />
                        <div className="absolute -bottom-20 -left-20 w-60 h-60 rounded-full bg-primary/3" />
