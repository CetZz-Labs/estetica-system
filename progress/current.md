...
3. UX-14 — Desfasaje horario en hora de visita/retoque (7:26 → 4:26, sospecha timezone UTC-3) ⬅ **en curso**
4. UX-15 — Crash de página en blanco al clickear turno pasado/tachado en calendario

**Tanda 2 — Mejoras UX (después de cerrar la tanda 1):**
...
**Próximo paso:** marcar UX-14 `in_progress` y lanzar un `explorer` para diagnosticar el desfasaje horario de 3hs (UTC-3) al mostrar la hora de una visita/retoque.
