...
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "estetica belleza wellness" --design-system

# Markdown - best for documentation
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "estetica belleza wellness" --design-system -f markdown
```
